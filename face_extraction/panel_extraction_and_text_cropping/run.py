...
from face_extraction.panel_extraction_and_text_cropping.panel_extractor import PanelExtractor
from face_extraction.panel_extraction_and_text_cropping.text_cropper import TextCropper
